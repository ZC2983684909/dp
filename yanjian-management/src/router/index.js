...
export const constantRoutes = [
...

  {
    ...
    children: [{
      ...
      meta: { title: '有趣的搭子', icon: 'el-icon-s-home' }
    }]
  },

  {
    ...
    children: [
      ...
      },
      {
        path: 'usercomplaint',
        name: 'usercomplaint',
        component: () => import('@/views/table/usercomplaint'),
        meta: { title: '用户投诉', icon: 'el-icon-phone' }
      },{
        path: 'complaintinfo/:id(\\d+)',
        component: () => import('@/views/table/complaintinfo'),
        name: 'complaintinfo',
        // meta: { title: '用户资料审核详情', noCache: true, activeMenu: '/example/table' },
        meta: { title: '审核详情', noCache: true },
        hidden: true
