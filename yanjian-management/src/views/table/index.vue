<template>
  <div class="app-container">
    <div class="filter-container" style="margin-bottom: 15px;">
      <el-select v-model="authStatus"  size="medium" placeholder="用户资料状态 " clearable class="filter-item" style="width: 180px">
    ...
    >
      ...
      <el-table-column label="实名认证状态" width="150" align="center">
        <template slot-scope="scope">
          <el-tag type="warning" v-if="scope.row.waitApprovedStatus=='1'">未认证</el-tag>
          <el-tag type="warning" v-if="scope.row.waitApprovedStatus=='2'">认证中</el-tag>
          <el-tag type="success" v-if="scope.row.waitApprovedStatus=='3'">通过</el-tag>
            <el-tag type="danger" v-if="scope.row.waitApprovedStatus=='4'">拒绝</el-tag>
              <el-tag type="danger" v-if="scope.row.waitApprovedStatus=='5'">失败</el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" width="130" class-name="small-padding fixed-width">
          <template slot-scope="scope">
            <router-link :to="'/example/examineinfo/'+scope.row.id+'/1'">
...
<script>
import { getList,getuserInfo,putuserExamine } from '@/api/table'
