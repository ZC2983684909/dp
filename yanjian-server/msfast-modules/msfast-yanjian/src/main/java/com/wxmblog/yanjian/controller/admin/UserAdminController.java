package com.wxmblog.yanjian.controller.admin;
...
public class UserAdminController {
    ...
    public R<PageResult<ComplaintPageResponse>> complaintPage(
            UserPageRequest request,
            @RequestParam(value = "pageIndex", required = false, defaultValue = "1") Integer pageIndex,
            @RequestParam(value = "pageSize", required = false, defaultValue = "10") Integer pageSize) {
        return R.ok(frUserService.complaintPage(request, pageIndex, pageSize));
    }
    ...
    @GetMapping("/info/{id}")
    public R<UserExamineInfoResponse> examineInfo(@PathVariable String id) {
    ...
    public R<EducationExamineInfoResponse> educationExamine(@PathVariable String id) {
    ...
    public R<PageResult<UserInfoAdminPageResponse>> userPage(
    ...
    public R<UserAdminInfoResponse> userAdminInfo(@PathVariable String id) {
    ...
    @ApiOperationSort(value = 12)
    @PostMapping("/check")
    public R<Void> checkUser(@RequestBody UserAdminCheckRequest request) {

        frUserService.checkUser(request);
        return R.ok();
    }
    ...
    public R<Void> postComplaint(@RequestBody UserAdminCheckRequest request) {

        frUserService.postComplaint(request);
        return R.ok();
    }
    ...
    public R<UserComplaintResponse> complaintInfo(@PathVariable String id) {
        return R.ok(frUserService.complaintInfo(id));
    }

    @ApiOperation("用户提现")
    @ApiOperationSort(value = 15)
    @PostMapping("/pay")
    public R<Void> pay(@RequestBody UserPayRequest request) {
        frUserService.pay(request);
        return R.ok();
    }
}
